...
<form action="/ToDoList/Controller/AddingTask" method="post" style="text-align:center" name="search">
    <fieldset>
        ...
        <button type="submit" class="mui-btn mui-btn--raised">Add Task</button>
