...
<br><br><br><br><br>
			<div class="alert alert-danger" role="alert">
  			<strong>Please fill in all the fields</strong></div>
			
			
			  <form class="navbar-form navbar-left" action="/ToDoList/Controller/AddTask" method="post">
                        <button type="submit" class="btn btn-default">Adding Task again</button>
             </form>
